...
class Ui_licenses_Dialog(object):
    def setupUi(self, licenses_Dialog):
        ...
        self.helios_ver_text.setEnabled(False)
        ...
        self.lasso_ver_text.setEnabled(False)
        ...
        self.qdot_ver_text.setEnabled(False)
        ...
        self.spu_ver_text.setEnabled(False)
        ...
        licenses_Dialog.setTabOrder(self.comboBox, self.merge)
        licenses_Dialog.setTabOrder(self.merge, self.sound)
        licenses_Dialog.setTabOrder(self.sound, self.paso)
        licenses_Dialog.setTabOrder(self.paso, self.cafe_2)
        licenses_Dialog.setTabOrder(self.cafe_2, self.rmt)
        licenses_Dialog.setTabOrder(self.rmt, self.smarttouch)
        licenses_Dialog.setTabOrder(self.smarttouch, self.nivu)
        licenses_Dialog.setTabOrder(self.nivu, self.visitag)
        licenses_Dialog.setTabOrder(self.visitag, self.activation3)
        licenses_Dialog.setTabOrder(self.activation3, self.segct)
        licenses_Dialog.setTabOrder(self.segct, self.replay)
        licenses_Dialog.setTabOrder(self.replay, self.ripple)
        licenses_Dialog.setTabOrder(self.ripple, self.famdx)
        licenses_Dialog.setTabOrder(self.famdx, self.qdotmicro)
        licenses_Dialog.setTabOrder(self.qdotmicro, self.visitagepu)
        licenses_Dialog.setTabOrder(self.visitagepu, self.sia)
        licenses_Dialog.setTabOrder(self.sia, self.complex)
        licenses_Dialog.setTabOrder(self.complex, self.hdcolor)
        licenses_Dialog.setTabOrder(self.hdcolor, self.prime)
        licenses_Dialog.setTabOrder(self.prime, self.helios)
        licenses_Dialog.setTabOrder(self.helios, self.dualmonitor)
        licenses_Dialog.setTabOrder(self.dualmonitor, self.confidense)
        licenses_Dialog.setTabOrder(self.confidense, self.finder)
        licenses_Dialog.setTabOrder(self.finder, self.visitagsur)
        licenses_Dialog.setTabOrder(self.visitagsur, self.activationv7sp2)
        licenses_Dialog.setTabOrder(self.activationv7sp2, self.activationv7)
        licenses_Dialog.setTabOrder(self.activationv7, self.activationv8)
        licenses_Dialog.setTabOrder(self.activationv8, self.soundfam)
        licenses_Dialog.setTabOrder(self.soundfam, self.activationv7p3)
        licenses_Dialog.setTabOrder(self.activationv7p3, self.baloon)
        licenses_Dialog.setTabOrder(self.baloon, self.segmr)
        licenses_Dialog.setTabOrder(self.segmr, self.ManualLine)
        licenses_Dialog.setTabOrder(self.ManualLine, self.sp_helios)
        licenses_Dialog.setTabOrder(self.sp_helios, self.sp_lasso)
        licenses_Dialog.setTabOrder(self.sp_lasso, self.sp_qdot)
        licenses_Dialog.setTabOrder(self.sp_qdot, self.sp_spu)
        licenses_Dialog.setTabOrder(self.sp_spu, self.confirm_button)
